...
import 'package:samadhaan_user/Screen/ReviewList.dart';
...
class StateItem extends State<ProductDetail> with TickerProviderStateMixin {
  ...
  bool variationapplied = false;
  double variationOff = 0.0;
            ...
            child: Align(
              ...
              child: Row(
                ...
                children:sliderList.map((e){
                  int i = sliderList.indexWhere((element) => element==e!);
                  return Container(
                    decoration: boxDecoration(
                      color: _curSlider==i?colors.primary:Colors.black,radius: 10,width: 4
                    ),
...
*/
  ...
  percentOff(double offValue) {
    double finalOff =
        (double.parse(widget.model!.prVarientList![pos].price.toString()) *
            ...
            100;
    print(
        "checking final percent of here ${finalOff} and ${widget.model!.prVarientList![pos].price} and more ${offValue}");
    return finalOff.toStringAsFixed(2);
  }

  _price(pos, from) {
    price = double.parse(widget.model!.prVarientList![pos].disPrice!);
    if (price == 0)
      price = double.parse(widget.model!.prVarientList![pos].price!);
    double off = 0;
    print("vvvvvvvvv ${off}");
    if (price != 0) {
      off = (double.parse(widget.model!.prVarientList![pos].price!) -
        ...
        children: [
          ...
          off != 0
              ? Container(
                  ...
                  width: 55,
                  decoration:
                      boxDecoration(bgColor: colors.primary, radius: 100),
                  padding: EdgeInsets.all(3.0),
                  child: Center(
                    child: Text(
                      "\u{20B9} ${variationOff.toStringAsFixed(2)} off",
                      style: Theme.of(context)
                          .textTheme
                          .overline!
          ...
          from
              ? Container(
                  decoration: boxDecoration(
                      bgColor: Colors.white, radius: 8, showShadow: true),
        ...
        child: Row(
          children: <Widget>[
            ...
            Container(
              height: 50,
              width: 50,
              decoration: boxDecoration(bgColor: colors.primary, radius: 100),
              padding: EdgeInsets.all(8.0),
              child: Center(
                child: Text(off.toStringAsFixed(2) + "%\noff",
                    style: Theme.of(context)
                        .textTheme
                        .overline!
                        .copyWith(color: Colors.white, letterSpacing: 0)),
  ...
  applyVarient() {
    ...
    if (price != 0) {
      ...
      off = off * 100 / double.parse(widget.model!.prVarientList![pos].price!);
      print(
          "off values  now here jow$off     nad ${widget.model!.prVarientList![pos].price}");
    }
    if (mounted)
      setState(() {
  ...
  _showContent() {
    ...
    return Column(children: <Widget>[
      Expanded(
        ...
        SliverAppBar(
          expandedHeight: MediaQuery.of(context).size.height * .38,
          floating: false,
          pinned: true,
                                ...
                                Padding(
                                  ...
                                  child: Row(
                                    children: [
                                      RatingBarIndicator(
                                        rating:
                                            double.parse(widget.model!.rating!),
                                        itemBuilder: (context, index) => Icon(
            ...
            child: InkWell(
              ...
              child: Column(
                ...
                children: <Widget>[
                    ...
                    child: Row(
                      ...
                      children: [
                        Container(
                          width: 80,
                          child: Text(
                            getString(productList[index].name!),
                            style: TextStyle(
                                color: Theme.of(context).colorScheme.fontColor,
                                fontWeight: FontWeight.bold),
                            maxLines: 2,
                    ...
                    child: Row(
                      ...
                      children: [
                        Container(
                          width: 100,
                          child: Text(
                              productList[index].seller_name.toString() + " ",
                              maxLines: 2,
                              overflow: TextOverflow.ellipsis,
                              style: TextStyle(
                                  color:
                  ...
                  /* Row(
                    children: [
                      Text(productList[index].seller_name.toString() + " ",
                          style: TextStyle(
                              color: Theme.of(context).colorScheme.fontColor,
                              fontWeight: FontWeight.bold)),
                      Text(
  ...
  _shortId() {
    return Padding(
      padding:
          const EdgeInsetsDirectional.only(start: 8, end: 8, top: 8, bottom: 5),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text(
