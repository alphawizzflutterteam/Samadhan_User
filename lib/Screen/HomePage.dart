...
import 'package:samadhaan_user/Model/Model.dart';
...
import 'package:samadhaan_user/Screen/NotificationLIst.dart';
import 'package:samadhaan_user/Screen/Search.dart';
import 'package:samadhaan_user/Screen/SellerList.dart';
import 'package:samadhaan_user/Screen/Seller_Details.dart';
import 'package:samadhaan_user/Screen/SubCategory.dart';
import 'package:samadhaan_user/Screen/starting_view/drawer_screen.dart';
import 'package:samadhaan_user/Screen/starting_view/feature_product.dart';
import 'package:samadhaan_user/Screen/starting_view/feature_view.dart';
...
class _HomePageState extends State<HomePage>
  ...
  getProductFeature() async {
    ...
    var request = http.Request('GET',
        Uri.parse('https://samadhaan.online/app/v1/api/get_features_product'));
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                                    ...
                                    children: [
                                      Padding(
                                        ...
                                        child: SizedBox(
                                          ...
                                          child: ClipRRect(
                                              ...
                                              child: Image.network(
                                                "${getFetatureProductModel?.data?[i].productImage}",
                                                scale: 4.0,
                                                fit: BoxFit.fill,
                                              )),
                                        ),
                                      ...
                                      Padding(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            Text(
                                              "${getFetatureProductModel?.data?[i].productName}",
                                              style: TextStyle(
                                            ...
                                            Text(
                                                "${getFetatureProductModel?.data?[i].description}"),
                                            Text(
                                                "${getFetatureProductModel?.data?[i].daysLeft} Days"),
                                            Text(
                                                "₹ ${getFetatureProductModel?.data?[i].price}"),
                                          ],
                                        ),
                                      )
                                    ],
                    ...
                    pages4.length > 0
                        ? _slider(pages4, 4, _controller4)
                        : SizedBox(),
                    _section(),
                    pages2.length > 0
                        ? _slider(pages2, 2, _controller2)
                        : SizedBox(),
                    // Text("section"),
                    //_section(),
  ...
  getLocation() async {
    ...
    setState(() {
      currentAddress.text =
          "${result.subLocalityLevel1!.name} , ${result.city!.name}";
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    ListView.builder(
                      itemCount: sectionList[index].productList!.length > 4
                          ? 4
                          : sectionList[index].productList!.length,
                      physics: NeverScrollableScrollPhysics(),
                      shrinkWrap: true,
                      itemBuilder: (context, index1) {
                        print(
                            "product data here is ${sectionList[index].productList!.length}");
                        return productItem(
                            index, index1, index1 % 2 == 0 ? true : false);
                      },
                    )
                    //_getSection(index),
                  ],
                                          ...
                                          Text(
                                            double.parse(sectionList[secPos]
                                                ...
                                                ? "MRP" +
                                                    ...
                                                    CUR_CURRENCY! +
                                                    "" +
                                                    "${double.parse(sectionList[secPos].productList![index].prVarientList![0].price.toString()).toStringAsFixed(2)}"
                                                : "",
                                            style: Theme.of(context)
                                                .textTheme
                                                .overline!
