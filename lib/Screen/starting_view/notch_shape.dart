...
class CircularNotchedAndCorneredRectangle extends NotchedShape {
  ...
  CircularNotchedAndCorneredRectangle(
      { required this.leftCornerRadius,required this.rightCornerRadius,required this.notchSmoothness});
  ...
  Path getOuterPath(Rect host, Rect? guest) {
    if (guest == null || !host.overlaps(guest)) {
      if (this.rightCornerRadius > 0 || this.leftCornerRadius > 0) {
        double leftCornerRadius =
            this.leftCornerRadius * ( 1);
        double rightCornerRadius =
            this.rightCornerRadius * ( 1);
        return Path()
    ...
    double leftCornerRadius = this.leftCornerRadius * ( 1);
    double rightCornerRadius = this.rightCornerRadius * ( 1);
