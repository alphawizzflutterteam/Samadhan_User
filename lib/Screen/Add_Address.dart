...
import 'package:samadhaan_user/Screen/Map.dart';
...
class StateAddress extends State<AddAddress> with TickerProviderStateMixin {
              ...
              content: Column(
                ...
                children: [
                  Padding(
                    ...
                    child: Text(
                      getTranslated(context, 'SELECT_SOCIETY')!,
  ...
  //                 },
  //                 decoration: InputDecoration(
  //                   label: Text("Building Wing & Flat No"),
  ...
  Future<void> addNewAddress() async {
    ...
    try {
      ...
      // print("object" + context.read<SettingProvider>().userId);

      print("parameters here ${data}");
