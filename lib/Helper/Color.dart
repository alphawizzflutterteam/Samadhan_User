...
extension colors on ColorScheme {
  ...
  static const Color primary = Color(0xff60db33);
  static const Color  secondary = Color(0xff60db33);
  /*static const Color secondary = Color(0xfff97e30);*/
  ...
  static const Color grad1Color = Color(0xffA3C940);
  static var grad2Color = Color(0xff0BA84A);
  ...
  static const Color red = Color(0xff60db33);
