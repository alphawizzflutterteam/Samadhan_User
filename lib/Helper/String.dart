...
final Uri getFourthSliderApi = Uri.parse(baseUrl + 'get_four_slider');
final Uri getFifthSliderApi = Uri.parse(baseUrl + 'get_five_slider');
final Uri getSixthSliderApi = Uri.parse(baseUrl + 'get_six_slider');
...
final Uri getUserLoginWithOtpApi = Uri.parse(baseUrl + 'login_with_otp');
...
final Uri getSocityApi = Uri.parse(baseUrl + 'get_society');
// https://samadhaan.online/app/v1/api/get_zipcodes
final Uri getZipCode = Uri.parse(baseUrl + 'get_zipcodes');
// https://samadhaan.online/app/v1/api/get_society
...
final Uri deliveryChargeByWeightApi =
    Uri.parse(baseUrl + 'get_delivery_charges');
...
const String SOCITYID = 'society_id';
